...
export const DUTERTEN_WITH_IMEE_AND_CAMILLE = DUTERTEN_SLATE.concat([
  "39. MARCOS, IMEE R. (NP)",
  "66. VILLAR, CAMILLE (NP)",
]);

export const KIKO_BAM_HEIDI = [
  "5. AQUINO, BAM (KNP)",
  "45. MENDOZA, HEIDI (IND)",
  "51. PANGILINAN, KIKO (LP)",
];

export const ALYANSA_WITHOUT_CAMILLE = [
  "1. ABALOS, BENHUR (PFP)",
  "9. BINAY, ABBY (NPC)",
  "11. BONG REVILLA,RAMON, JR.(LAKAS)",
  "18. CAYETANO, PIA (NP)",
...
export const ALYANSA_WITH_CAMIILLE = ALYANSA_WITHOUT_CAMILLE.concat([
  "66. VILLAR, CAMILLE (NP)",
]);

export const ALYANSA_WITH_CAMILLE_AND_IMEE = ALYANSA_WITH_CAMIILLE.concat([
  "39. MARCOS, IMEE R. (NP)",
  "66. VILLAR, CAMILLE (NP)",
]);
